...
clip1 = VideoFileClip("204307-923909646.mp4").subclip(0, 5)
clip2 = VideoFileClip("38891-418897479.mp4").subclip(0, 5)
  
# getting only first 5 seconds
# clip1 = clip.subclip(0, 5)
  
# # rotating clip by 180 degree to get the clip3
clip2 = clip1.set_start(3)
...
# showing final clip
final.write_videofile("crossfade.mp4")
